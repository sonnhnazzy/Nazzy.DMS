...
public class BitmapHelper {
    ...
    public static Bitmap decodeFile(File bitmapFile, int requiredWidth,
        ...
        try {
            ...
            bitmapDecodeOptions.inPreferredConfig = quickAndDirty ? Config.RGB_565
                    : Config.ARGB_8888;
            ...
            float srcWidth = bitmapDecodeOptions.outWidth;
            float srcHeight = bitmapDecodeOptions.outHeight;

            float dstWidth = requiredWidth;
            float dstHeight = requiredHeight;
            ...
            if (scaledBitmapWidth > requiredWidth) {
                ...
                croppedBitmap = Bitmap.createBitmap(scaledBitmap, xOffset, 0,
                        requiredWidth, requiredHeight);
                scaledBitmap.recycle();
            } else if (scaledBitmapHeight > requiredHeight) {
                int yOffset = (scaledBitmapHeight - requiredHeight) / 2;
                croppedBitmap = Bitmap.createBitmap(scaledBitmap, 0, yOffset,
                        requiredWidth, requiredHeight);
                scaledBitmap.recycle();
            }
